...
#wrtbwmon
git clone https://github.com/brvphoenix/luci-app-wrtbwmon packag/lean/luci-app-wrtbwmon
#DDNS
...
#kcpufreq CPU性能优化
git clone -b master --single-branch https://github.com/kongfl888/luci-app-kcpufreq package/lean/luci-app-kcpufreq
#FullCone模块
